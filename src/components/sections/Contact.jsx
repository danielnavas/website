...
export const Contact = () => {
    ...
    {/*sets up alert that confirms whether or not the email was sent. Taken from github.com/machadop1407*/}
            ...
            <RevealOnScroll>
                <div className="px-2 w-xs md:w-150">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="w-full bg-teal-500 border border-teal-500/50 text-black py-3 px-6 rounded font-medium
                        transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)] hover:bg-black hover:text-teal-400">
                            Send Message
                        </button>
                    </form>                  
                </div>
